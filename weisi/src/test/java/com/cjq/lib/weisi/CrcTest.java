...
import com.wsn.lib.wsb.protocol.Crc;
...
public class CrcTest {
    ...
    public void ccitt_calc16ByMsb() {
        ...
        int expect = 0x9E1B;
        int actual = Crc.Companion.getCcitt().calc16ByMsb(data);
    ...
    public void ccitt_isCorrect16_bufMsb_srcCrc_crcMsb() {
        byte[] data = {(byte) 0xFF, (byte) 0xFF, 0x01, 0x6C};
        boolean expect = true;
        boolean actual = Crc.Companion.getCcitt().isCorrect16(data, 0, data.length, true, 0x9E1B, true);
        //System.out.print(String.format("%04X", actual));
        assertEquals(expect, actual);
    }
    ...
    public void ccitt_isCorrect16WithCrcAppended() {
        ...
        boolean expect = true;
        boolean actual = Crc.Companion.getCcitt().isCorrect16WithCrcAppended(data, 0, 29, 0xCE09, true, true);
        //System.out.print(String.format("%04X", actual));
        assertEquals(expect, actual);
    }
