...
import static com.cjq.lib.weisi.iot.container.ValueContainer.ADD_FAILED_RETURN_VALUE;
import static com.cjq.lib.weisi.iot.container.ValueContainer.ADD_VALUE_FAILED;
import static com.cjq.lib.weisi.iot.container.ValueContainer.LOOP_VALUE_ADDED;
import static com.cjq.lib.weisi.iot.container.ValueContainer.NEW_VALUE_ADDED;
import static com.cjq.lib.weisi.iot.container.ValueContainer.VALUE_UPDATED;
...
public class DynamicValueContainerTest {
    ...
    public void addValue() {
        ...
        assertEquals(0, container.getPhysicalPositionByLogicalPosition(addResult));
        ...
        assertEquals(1, container.getPhysicalPositionByLogicalPosition(addResult));
        assertEquals(NEW_VALUE_ADDED, container.interpretAddResult(addResult));
        ...
        for (int i = 3;i < 50;++i) {
            ...
            assertEquals(i, container.getPhysicalPositionByLogicalPosition(addResult));
            assertEquals(NEW_VALUE_ADDED, container.interpretAddResult(addResult));
        ...
        assertEquals(99, addResult);
        assertEquals(49, container.getPhysicalPositionByLogicalPosition(addResult));
        ...
        assertEquals(44, container.getPhysicalPositionByLogicalPosition(addResult));
        assertEquals(VALUE_UPDATED, container.interpretAddResult(addResult));
        assertEquals(50, container.size());
        assertEquals(false, container.empty());
        assertEquals(10, container.getEarliestValue().getTimestamp());
        ...
        assertEquals(83, addResult);
        assertEquals(33, container.getPhysicalPositionByLogicalPosition(addResult));
        assertEquals(LOOP_VALUE_ADDED, container.interpretAddResult(addResult));
        assertEquals(50, container.size());
        assertEquals(false, container.empty());
    ...
    public void addValue11() {
        ...
        assertEquals(98, addResult);
        assertEquals(48, container.getPhysicalPositionByLogicalPosition(addResult));
        assertEquals(LOOP_VALUE_ADDED, container.interpretAddResult(addResult));
        assertEquals(50, container.size());
        assertEquals(false, container.empty());
